...
import { PreviewSettingsPopover } from "@/features/preview/components/preview-setting-popover"
            ...
            <div className="flex-1 min-h-0">
                <Allotment vertical>
                    <Allotment.Pane>
                        ...
                        {previewUrl && (
                            <iframe src={previewUrl} className="size-full border-0" title="preview"/>
                        )}
                    ...
                    {showTerminal && (
                        <Allotment.Pane
                        minSize={100} maxSize={500} preferredSize={200}
                        >
